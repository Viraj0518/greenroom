...
const tiles = [
  ...
  { to: '/embed/speakers/devconf-2026', title: 'Speaker embed', desc: 'Drop-in speaker gallery for your event site.', glyph: '👥' },
  { to: '/embed/schedule/devconf-2026', title: 'Schedule embed', desc: 'Mobile-friendly agenda embed, grouped by day and room.', glyph: '📅' },
]
  ...
  return (
    <main style={{ maxWidth: 860, margin: '0 auto', padding: '9vh 20px 60px' }}>
      ...
      <div style={{ display: 'grid', gap: 14, gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))' }}>
        {tiles.map((t) => (
          <Link key={t.to} to={t.to} className="card card-pad" style={{ textDecoration: 'none', color: 'inherit' }}>
